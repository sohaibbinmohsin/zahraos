...
describe("youthRepublicFunctions", () => {
  ...
  it("createOpportunity posts to create-opportunity", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(`${YOUTH_REPUBLIC_FUNCTIONS_URL}/create-opportunity`, expect.anything());
  });
  ...
  it("updateOpportunity posts to update-opportunity", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(`${YOUTH_REPUBLIC_FUNCTIONS_URL}/update-opportunity`, expect.anything());
  });
