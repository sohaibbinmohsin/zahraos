...
const ACTION_TYPES = ["Member Added", "Access Changed", "Member Removed", "Role Created", "Role Modified", "Chapter Created", "Chapter Updated"];
...
function badgeClass(action: string) {
  ...
  if (action === "Member Added") return "badge-pend";
  return "badge-pos";
}
